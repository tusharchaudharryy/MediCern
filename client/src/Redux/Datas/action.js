...
export const GetDoctorDetails = () => async (dispatch) => {
  try {
    ...
    const res = await axios.get(
      "https://hospital-management-system-backend.onrender.com/doctors"
    );
    console.log(res);
    // dispatch({
...
export const AddPatients = (data) => async (dispatch) => {
  try {
    ...
    const res = await axios.post(
      "https://hospital-management-system-backend.onrender.com/patients/register",
      data
    );
...
export const CreateBeds = (data) => async (dispatch) => {
  try {
    ...
    const res = await axios.post(
      "https://hospital-management-system-backend.onrender.com/beds/add",
      data
    );
    return res.data;
    // dispatch({
...
export const CreatePayment = (data) => async (dispatch) => {
  try {
    ...
    const res = await axios.post(
      "https://hospital-management-system-backend.onrender.com/payments/add",
      data
    );
...
export const GetBeds = () => async (dispatch) => {
  try {
    ...
    const res = await axios.get("https://hospital-management-system-backend.onrender.com/beds");
    console.log(res);
    dispatch({
...
export const CreateBooking = (data) => async (dispatch) => {
  try {
    ...
    const res = await axios.post(
      `https://hospital-management-system-backend.onrender.com/appointments/create`,
      data
    );
    console.log(res);
...
export const GetSingleBed = (data) => async (dispatch) => {
  try {
    ...
    const res = await axios.post(
      "https://hospital-management-system-backend.onrender.com/beds/single",
      data
    );
    // console.log(res);
    return res.data;
...
export const EditSingleBed = (data, id) => async (dispatch) => {
  try {
    ...
    const res = await axios.patch(
      `https://hospital-management-system-backend.onrender.com/beds/${id}`,
      data
    );
    // console.log(res);
    return res.data;
...
export const dischargePatient = (data) => async (dispatch) => {
  try {
    ...
    const res = await axios.put(
      `https://hospital-management-system-backend.onrender.com/beds/discharge`,
      data
    );
    console.log(res);
    // return res.data;
...
export const GetPatients = () => async (dispatch) => {
  try {
    ...
    const res = await axios.get(
      `https://hospital-management-system-backend.onrender.com/patients`
    );
    console.log(res.data);
    dispatch({
...
export const GetAllData = () => async (dispatch) => {
  try {
    ...
    const res = await axios.get(
      `https://hospital-management-system-backend.onrender.com/hospitals`
    );
    console.log(res.data);
    dispatch({
...
export const GetAllAppointment = () => async (dispatch) => {
  try {
    ...
    const res = await axios.get(
      `https://hospital-management-system-backend.onrender.com/appointments`
    );
    // console.log(res.data);
    // return res.data;
    dispatch({
...
export const DeleteAppointment = (id) => async (dispatch) => {
  try {
    ...
    const res = await axios.delete(
      `https://hospital-management-system-backend.onrender.com/appointments/${id}`
    );
    console.log(res.data);
    // return res.data;
    dispatch({
...
export const GetAllReports = () => async (dispatch) => {
  try {
    ...
    const res = await axios.get(
      `https://hospital-management-system-backend.onrender.com/reports`
    );
    // console.log(res.data);
    return res.data;
    // dispatch({
