...
export const DoctorLogin = (data) => async (dispatch) => {
  try {
    ...
    const res = await axios.post(
      "https://hospital-management-system-backend.onrender.com/doctors/login",
      data
    );
...
export const AdminLogin = (data) => async (dispatch) => {
  try {
    ...
    const res = await axios.post(
      "https://hospital-management-system-backend.onrender.com/admin/login",
      data
    );
    console.log(res.data);
    dispatch({
...
export const DoctorRegister = (data) => async (dispatch) => {
  try {
    ...
    const res = await axios.post(
      "https://hospital-management-system-backend.onrender.com/doctors/register",
      data
    );
    // console.log(res);
    return res.data;
...
export const NurseRegister = (data) => async (dispatch) => {
  try {
    ...
    const res = await axios.post(
      "https://hospital-management-system-backend.onrender.com/nurses/register",
      data
    );
    // console.log(res);
    return res.data;
...
export const AdminRegister = (data) => async (dispatch) => {
  try {
    ...
    const res = await axios.post(
      "https://hospital-management-system-backend.onrender.com/admin/register",
      data
    );
    // console.log(res);
    return res.data;
...
export const AmbulanceRegister = (data) => async (dispatch) => {
  try {
    ...
    const res = await axios.post(
      "https://hospital-management-system-backend.onrender.com/ambulances/add",
      data
    );
    console.log(res);
    // dispatch({
...
export const UpdateNurse = (data, id) => async (dispatch) => {
  try {
    ...
    const res = await axios.patch(
      `https://hospital-management-system-backend.onrender.com/nurses/${id}`,
      data
    );
    console.log(res);
...
export const UpdateDoctor = (data, id) => async (dispatch) => {
  try {
    ...
    const res = await axios.patch(
      `https://hospital-management-system-backend.onrender.com/doctors/${id}`,
      data
    );
    console.log(res);
...
export const SendPassword = (data) => async (dispatch) => {
  try {
    dispatch({ type: types.EDIT_DOCTOR_REQUEST });
    const res = await axios.post(
      `https://hospital-management-system-backend.onrender.com/admin/password`,
      data
    );
    // console.log(res);
    return res.data;
...
export const forgetPassword = (data) => async (dispatch) => {
  try {
    ...
    const res = await axios.post(
      `https://hospital-management-system-backend.onrender.com/admin/forgot`,
      data
    );
    // console.log(res);
    return res.data;
